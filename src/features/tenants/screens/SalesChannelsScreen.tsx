            ...
            return (
              <TouchableOpacity
                ...
                <View style={[styles.channelIcon, active && styles.channelIconActive]}>
                  <Icon size={20} color={active ? '#fff' : C.ink} strokeWidth={1.75} />
                </View>
...
const styles = StyleSheet.create({
  ...
  channelCardActive: { borderColor: C.ink, backgroundColor: '#F7F5EE' },
  channelIcon: {
    width: 40, height: 40, borderRadius: 10,
    backgroundColor: C.cardBg, borderWidth: 1, borderColor: C.border,
    alignItems: 'center', justifyContent: 'center',
  },
  channelIconActive: { backgroundColor: C.ink, borderColor: C.ink },
  channelText: { flex: 1, gap: 2 },
  channelLabel: { fontSize: 15, fontWeight: '600', color: C.ink },
  channelLabelActive: { color: C.ink },
  channelDescription: { fontSize: 12, color: C.muted },
  check: {
    width: 22, height: 22, borderRadius: 11,
    borderWidth: 1.5, borderColor: C.border,
    alignItems: 'center', justifyContent: 'center',
  },
  checkActive: { backgroundColor: C.ink, borderColor: C.ink },
