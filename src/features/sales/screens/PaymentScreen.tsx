                ...
                <React.Fragment key={m.id}>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={[s.methodIcon, active && s.methodIconActive]}>
                      <m.Icon size={18} color={active ? '#fff' : colors.muted} strokeWidth={1.75} />
                    </View>
        ...
        <View style={s.section}>
          ...
          <View style={s.channelGrid}>
            {CHANNELS.map(ch => {
              ...
              const iconColor = active ? (ch.dark ? colors.ink : '#fff') : colors.muted;
              return (
                <TouchableOpacity
                  key={ch.id}
                  style={[
                  ...
                  <View style={[
                    s.channelIcon,
                    { backgroundColor: active ? ch.color : colors.cardBg },
                  ]}>
...
const make_s = (colors: ThemeColors) => StyleSheet.create({
  ...
  headerText: { gap: 1 },
  title: { fontSize: 26, fontWeight: '800', color: colors.ink, letterSpacing: -0.8 },
  ...
  section: { gap: 10 },
  sectionLabel: { fontSize: 10, fontWeight: '700', color: colors.muted, letterSpacing: 1 },
  ...
  methodDivider: { height: 1, backgroundColor: colors.border },
  ...
  channelLabel: { fontSize: 11, fontWeight: '600', color: colors.muted, flex: 1 },
